...
if(idp > 0)then
  set msg = "Usuário já cadastrado anteriormente.";
	...
	if(idx = -1) then
	   ...
	   select * from pessoa inner join endereco on 
...
call iCadastroPessoa("Maria Gonçalves", "1968-03-23", "mariag", 
"maria123", "Cliente", "maria@bol.com.br", "153.558.879-96", 
"01001-000", "Praça da Sé", "lado ímpar", "Sé", "São Paulo", 
"SP", @msg);
